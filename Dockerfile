...
RUN apt-get update
RUN apt-get install -y wget curl postfix-mysql dovecot-mysql dovecot-imapd dovecot-lmtpd php5 php5-fpm php5-common php5-mysql spamassassin php5-imap postfixadmin roundcube
...
# Install Caddy
RUN wget -q https://github.com/mholt/caddy/releases/download/v0.9.5/caddy_linux_amd64.tar.gz
RUN mkdir /caddy
